...
pub const JAPANESE_CONDITIONS: &[(u32, Condition)] = &[
    (
        Conditions::V.into(),
        Condition {
            name: "Verb",
...
pub const JAPANESE_TRANSFORMS: &[Transform] = &[
    ...
    Transform {
        ...
        rules: &[
            suffix_inflection(
                "ん",
                "る",
                Conditions::N.with_subconditions(),
                Conditions::V1.with_subconditions(),
            ),
            suffix_inflection(
                "かん",
    ...
    Transform {
        ...
        rules: &[
            ...
            suffix_inflection(
                "かす",
                "く",
                Conditions::V5SP.with_subconditions(),
                Conditions::V5.with_subconditions(),
            ),
            suffix_inflection(
                "がす",
    ...
    Transform {
        ...
        rules: &[
            ...
            suffix_inflection(
                "てる",
                "て",
                Conditions::V1P.with_subconditions(),
                Conditions::TE.with_subconditions(),
            ),
            suffix_inflection(
                "でいる",
    ...
    Transform {
        ...
        rules: &[suffix_inflection(
            ...
            "る",
            0,
            Conditions::V.with_subconditions(),
        )],
    },
    Transform {
        name: "kansai-ben",
