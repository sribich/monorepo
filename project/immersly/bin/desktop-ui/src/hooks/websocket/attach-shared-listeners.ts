...
import type { HeartbeatOptions, Options, SendMessage } from "./types"
...
const bindOpenHandler = (webSocketInstance: WebSocket, url: string) => {
...
const bindCloseHandler = (webSocketInstance: WebSocket, url: string) => {
...
const bindErrorHandler = (webSocketInstance: WebSocket, url: string) => {
