...
pub struct GetExactWordQueryRequest {
    pub word: String,
    pub reading: Option<String>,
}

#[derive(Debug, Serialize, Typegen)]
pub struct GetExactWordQueryResponse {
    word: DictionaryWord,
}
...
#[derive(Component)]
pub struct GetExactWordQuery {
    db: Arc<Sqlite>,
}

impl UseCase for GetExactWordQuery {
    type Err = core::convert::Infallible;
    type Req = GetExactWordQueryRequest;
    type Res = GetExactWordQueryResponse;
