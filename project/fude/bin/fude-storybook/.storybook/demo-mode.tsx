...
export const demoModeLoader: Loader = async (context) => {
    ...
    if (shouldUseDemoMode && context.globals["demoMode"] === "on") {
        context.userEvent = {
            ...userEvent,
            // Make any typing take .5 total seconds
            type: async (...args) => {
...
const moveMouseTo = (target: Element, options: MoveMouseOptions): Promise<undefined | void> => {
    if (!target) {
