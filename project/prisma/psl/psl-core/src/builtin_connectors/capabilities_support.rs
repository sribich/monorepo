...
cfg_if! {
    ...
    if #[cfg(all(feature="mysql", not(any(feature = "postgresql", feature="sqlite"))))] {
        #[inline(always)]
    ...
    } else if #[cfg(all(feature="sqlite", not(any(feature = "postgresql", feature="mysql"))))] {
        #[inline(always)]
        const fn can_have_capability_impl(capability: ConnectorCapability) -> bool {
    ...
    } else if #[cfg(all(feature="postgresql", not(any(feature = "sqlite", feature="mysql"))))] {
        #[inline(always)]
        const fn can_have_capability_impl(capability: ConnectorCapability) -> bool {
