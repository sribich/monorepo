...
fn nice_error_for_unknown_generator_preview_feature() {
    ...
    let expectation = expect![[r#"
        [1;91merror[0m: [1mThe preview feature "foo" is not known. Expected one of: metrics, nativeDistinct, postgresqlExtensions, relationJoins, shardKeys, strictUndefinedChecks, views[0m
